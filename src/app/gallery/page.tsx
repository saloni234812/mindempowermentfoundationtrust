          ...
          <div className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center p-4">
            ...
            <div className="relative max-w-4xl max-h-[85vh] rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              ...
              {(activeMedia.includes("activity_7.jpg") || activeMedia.includes("activity_12.jpg") || activeMedia.includes("activity_16.jpg")) && (
                <div className="absolute top-4 right-4 z-20 h-12 w-12 bg-white/95 rounded-full p-2 shadow-lg border border-white/10 select-none pointer-events-none flex items-center justify-center">
                  <img src="/logo.png" alt="MEFT Logo" className="h-full w-full object-contain" />
                </div>
              )}
            </div>
